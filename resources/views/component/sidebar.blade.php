<div id="sidebar" class='active'>
    <div class="sidebar-wrapper d-flex flex-column  active">
        ...
        <div class="d-grid px-2 mb-4">
            <button class='btn btn-outline-primary' type="button" class="btn btn-primary" data-bs-toggle="modal"
