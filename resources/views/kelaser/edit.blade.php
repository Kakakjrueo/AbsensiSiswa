...
<head>
    ...
    <title> Edit Kelas - Aplikasi Absensi Siswa </title>
            ...
            <div class="main-content container-fluid mb-auto">
                ...
                <section class="section">
                    <div class="row mb-2">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form" action="{{ route('kelaser.update', $kelaser->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="namlas" value="{{ $kelaser->namlas }}"
                                                    class="form-control" placeholder="Namlas">
                                            </div>
                                        </div>
