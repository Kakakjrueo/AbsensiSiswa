                ...
                <div class="row">
                  <div class="col-md-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control" placeholder="Masukkan Username" value="{{ old('name') }}">
                      @error('name')
                  ...
                  <div class="col-md-6 col-12">
                    <div class="form-group">
                      ...
                      <select class="form-select" name="role">
                        ...
                        <option value="walas" {{ old('role') == 'walas' ? 'selected' : '' }}>Walas</option>
                  ...
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Masukkan Mapel" name="mapel" value="{{ old('mapel') }}">
                      @error('mapel')
                        <div class="text-danger">{{ $message }}</div>
                      @enderror
                    </div>
